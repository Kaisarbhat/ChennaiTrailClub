    ...
    <div>
      ...
      <div className="bg-[#070802] text-white box-border h-full flex flex-col items-center py-40  px-80">
        <div className="flex space-x-10">
          ...
          <div className="flex flex-col justify-between mb-10 space-y-6">
            ...
            <button className="text-[18px] border border-solid  text-[#50514c] rounded-3xl p-2 w-[170px] hover:bg-[#D0F700] font-bold hover:text-black">
              View Details
            </button>
          </div>
        </div>
      ...
      <div className="md:px-3 py-6 lg:px-80 ">
        ...
        <div className="flex justify-between ">
          <div className="w-3/6 border border-solid hover:shadow-2xl hover:shadow-violet-800  rounded-xl  flex p-2 space-x-3 my-6 min-h-72 justify-between">
            ...
            <div className="flex flex-col justify-between ml-1">
              ...
              <button className="text-[14px] border  bg-black border-solid  text-[#D0F700] rounded-3xl p-2 w-[170px] hover:bg-[#D0F700] font-bold hover:text-black">
                Register
              </button>
            </div>
          </div>
