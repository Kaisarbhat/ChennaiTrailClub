...
const UpcomingEvents = () => {
  ...
  return (
    <div>
      <div className="mb-4">
        <div className="bg-[#070802] text-white box-border h-full flex flex-col items-center py-40  lg:px-80 md:px-4 font-serif">
          <div className="flex space-x-10">
            <div className="flex flex-col text-wrap w-4/5">
              <h1 className="text-[38px]">
                Jawadhu Hills Ultra (JHU-24)
              </h1>
              <p className="text-xl text-[#ffffffb8] leading-normal mt-5 font-man">awadhu Hills Ultra (JHU-24)
