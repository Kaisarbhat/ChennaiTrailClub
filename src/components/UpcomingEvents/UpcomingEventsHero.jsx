...
function UpcomingEventsHero({ data }) {
  ...
  return (
    <section
      className="overflow-clip bg-[#070802] xs:min-h-[100vh] sm:min-h-[71vh] md:min-h-[100vh] text-white box-border flex flex-col pt-12 md:px-4 font-serif items-center justify-evenly"
