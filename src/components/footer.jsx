  ...
  return (
    <>
      <div className="w-screen lg:flex xs:hidden md:hidden justify-center items-center bottom-0 overflow-clip">
        <div className="2xl:w-[1340px]  lg:w-full ">
            ...
            <div className="w-full  md:mx-3 rounded-3xl  text-[#FCFDF8] bg-black px-12 py-8  mb-0 h-[270px] text-[14px] flex items-start justify-between">
              <div className="flex flex-col w-[350px]">
                ...
                <p className="text-[#B6B6B3] mt-3 text-[16px]">
                  Join us for epic outdoor adventures and bond with fellow
                  nature enthusiasts
                </p>
                <div className="mt-4">
      ...
      <div className="w-full lg:hidden md:block xs:block bottom-0 overflow-clip">
