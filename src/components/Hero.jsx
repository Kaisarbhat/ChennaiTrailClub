  ...
  return (
    ...
    <div className="h-screen w-full  lg:px-80 flex items-center justify-center bg-black text-white space-x-20 bg-[url('https://c0.wallpaperflare.com/preview/894/641/116/asphalt-dark-dawn-environment.jpg')] bg-cover bg-fixed">
      ...
      <div className="flex flex-col flex-1 mx-4">
        <h1 className="text-5xl font-bold mb-8">Jawadhu Hills Ultra 2024 (JHU-24)</h1>
        ...
        <Button title={'JNU 2024'}/>
      </div>
    </div>
    <div className="flex justify-center">
    <div className="flex flex-col items-center p-20 max-w-6xl ">
      <h1 className="text-2xl">Lets Explore Together</h1>
      <h1 className="mt-8 text-5xl font-bold">Welcome to Chennai Trail Club</h1>
      <p className="mt-8 text-xl text-center">At Chennai Trail Club, we believe in the transformative power of individuals who are embracing nature constantly. We are a passionate community of outdoor enthusiasts who share a common love for trail running, hiking, swimming and exploration.</p>
