...
function AboutUsTextLower() {
  ...
  return (
    <div
      className="w-full flex md:flex-row xs:flex-col  xs:items-center md:items-start md:justify-between  xs:px-4 xs:py-12 md:py-[100px] md:px-4 lg:space-x-14 xs:space-x-0  xs:text-center md:text-start 2xl:max-w-[1340px] "
