...
const Hero = ({ recentEvent, formattedDate }) => {
  return (
    <div className="relative z-10 2xl:max-w-[1340px] 2xl:space-x-20 h-screen w-full flex md:flex-row sm:flex-col xs:flex-col xs:pt-12 sm:pt-14 md:pt-10 items-center justify-center space-x-4">
      <motion.div
