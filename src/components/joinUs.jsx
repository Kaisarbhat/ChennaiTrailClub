...
const JoinUs = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-md z-50">
      <div className="relative w-11/12 md:w-3/5 bg-[#FCFDF8] max-h-[90vh] flex border border-solid border-black rounded-2xl xs:p-4 md:p-6 md:space-x-6 xs:space-x-0 text-black min-h-[700px]">
        <button
          onClick={onClose}
        ...
        <div className="xs:hidden xs:w-0 md:w-1/2 md:flex bg-[url('/join-us-img.png')] min-h-[600px] bg-cover flex-col justify-end items-center md:px-10 xs:px-3 py-10">
        ...
        <div className="flex flex-col text-[14px] space-y-6 xs:w-full md:w-1/2">
