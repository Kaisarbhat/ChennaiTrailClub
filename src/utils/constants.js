  ...
  <>
    <div className="overflow-auto max-h-[550px] text-xs p-7 space-y-4  border border-solid rounded-lg">
      <p>
        ...
        <b className="underline">Jawadhu Hills Ultra 2024 </b>("this event") and
        I agree to participate in this event at my own risk. I know that
        ...
        risks involved, some of which have been summarized in the 'Risk Factors'
        described below, and I hereby acknowledge the same. I am aware that the
        risks involved are not limited to the Risk Factors, and I assume all the
        risks involved in participating to this event
      </p>
      <p>
        ...
        right of any official to deny or suspend my participation for any reason
        whatsoever.
      </p>
      <p>
        I hereby acknowledge and agree to waive, release, keep indemnified and
        discharge all persons, corporations, associations and bodies involved or
        otherwise engaged in organizing, promoting or staging this event and
        their servants, agents, representatives, officials and employees. This
        includes but is not limited to race officials, agents, volunteers, event
        organisers and sponsors whether or not the loss, injury or damage is
        attributed to the act or neglect of any one or more of them.
      </p>
      <p>
        I understand that competing in this event will involve running and
        walking on remote wilderness trails with rocks, roots, stream crossings,
        and up and down steep terrain. I assume all risks associated with
        running in this event, including but not limited to: steep drops on or
        near the course, challenging terrain, rocks, roots, adjacent streams,
        motor vehicle traffic, slippery surfaces, loose rocks, soft sand,
        adverse weather conditions, heat exhaustion, dehydration, hypothermia,
        venomous snakes, wild boars etc., all such risks being known and
        appreciated by me.
      </p>
      <p>
        I hereby allow and permit the use of my image(s), photograph(s),
        videos(s), recording(s) and/or any other record of this event to be used
        in the media and for marketing purposes of this event.
      </p>
      <p>
        I hereby attest and confirm that I am physically fit and am sufficiently
        trained to participate in this event. I hereby consent to receive
        medical treatment which may be deemed advisable in the event of injury,
        accident and/or illness during this event. I understand that all medical
        and/or emergency evacuation costs for participants or crew will be borne
        by that person or their heirs. The race organizers are in no way liable
      ...
      <p>
        ...
        diseases and have not been advised by doctors to do physical activities
        under supervision. I also confirm that I have never been diagnosed with
        any chronic illness and have never experienced dizziness or chest pain
        while running or during any physical activity.
      </p>
      ...
      <p>
        ...
        medical emergency, runners will be transported to the nearest hospital.
        However, due to difficult terrain and inaccessibility to majority of the
        course, this may take time, even upto a few hours in some cases.
      </p>
      <p>
      ...
      <p>
        It is important for each entrant to recognize the potential physical and
        mental stresses, which may arise from participation in this event.
        ...
        understand their own limitations. This is an event where it is better to
        follow the dictates of your body - not your ambitions! Adequate physical
        and mental conditioning prior to the event is mandatory. If you have not
        been able to prepare properly, do not attempt to run! runners must
        appreciate the risks associated with participation in this event.
        Actions may have to be taken on your behalf under extreme time
        constraints and adverse circumstances. The race officials will make
        reasonable efforts to give assistance whenever possible. Ultimately and
        primarily, you are in charge, and you are solely responsible for
        creating your own crisis. Be careful, be responsible, and do not exceed
        your own abilities and limitations.
      </p>
      <p>
        Some of the main risks of this event, but certainly not all of them, are
        listed. These should be understood and remembered by all runners, before
        and during the event. Please note that death can result from several of
        the risk conditions discussed below or from other aspects of
      ...
      <ol className="list-decimal space-y-4">
        <li>
          ...
          <ol className="list-alpha">
            <li>
              ...
              permanent impairment of kidney function. IT IS CRUCIAL TO HYDRATE
              YOURSELF USING ELECTROLYTE FLUIDS DURING THE RUN AND FOR SEVERAL
              DAYS FOLLOWING THE RUN.
            </li>
          </ol>
        </li>
        <li>
          ...
          <ol className="list-alpha">
            <li>
              ...
              important that runners be aware of the symptoms of impending heat
              injury. These include but are not limited to: nausea, vomiting,
              headache, dizziness, irritability, lassitude, confusion, weakness,
              and rapidheart rate. Impending heat stroke may be preceded by a
              ...
              heat when running up and down hill. The faster the pace, the more
              heat is produced. A light-colored shirt and cap, particularly if
              kept wet during the event, can help. If signs of heat exhaustion
              occur, we recommend rapid cooling by applying ice to the groin,
              neck and armpits. We also recommend that runners keep themselves
              adequately hydrated and carry fluids between aid
        ...
        <li>
          ...
          <ol className="list-alpha">
            <li>
              ...
              been associated with severe illness requiring hospitalization. It
              is important for long-distance athletes to use fluids containing
              electrolytes to replace the water and salts lost during the run.
              WATER INTAKE ALONE IS NOT SUFFICIENT, as water intoxication and
              possibly death may result. This problem may in fact worsen after
              the Race, as the non-electrolyte-containing fluid which has been
              accumulating in the stomach is absorbed. Potassium and calcium
              replacement may also be important, although these levels change
              less with fluid loss and replenishment. Signs and symptoms of
              hyponatremia include weight gain, bloating, nausea, vomiting,
              headache, confusion, incoordination, dizziness, muscle
              twitching/cramping and fatigue. If left untreated, it may progress
              to seizures, pulmonary and cerebral edema, coma, and death. The
              best way to achieve proper electrolyte and fluid balance is to
              hydrate with fluids containing proper amounts of electrolytes and
              to replace with sodium-containing foods or supplements, if
              required, and as determined during your training. Potassium, while
              present in many electrolyte-replacement solutions, may also be
              replaced with fruit, such as bananas or oranges. BEER or other
              ALCOHOLIC BEVERAGES should not be taken at any time during or
              before the run
            </li>
          </ol>
        </li>
        <li>
          ...
          <ol className="list-alpha">
            <li>
              ...
              running course traverses through an area with inherent risks posed
              by wildlife. Participants acknowledge and assume these risks by
              participating.
              <ul className="list-disc">
                <li>
                  <b>Snakes:</b> This area may be inhabited by venomous snakes
                  that pose a serious and potentially life-threatening risk.
                  Approaching any snake is strictly prohibited. In the event of
                  a snakebite, timely medical assistance is not guaranteed.
                </li>
                <li>
                  <b>Domestic Animals:</b>Runners may encounter dogs in
                  villages. To minimize the risk of bites, runners should avoid
                  eye contact and proceed with caution.
                </li>
                <li>
                ...
                <li>
                  ...
                  Mosquitoes and leeches are prevalent in the area. Participants
                  are strongly encouraged to wear protective clothing and apply
                  insect repellent.
                </li>
              </ul>
            </li>
        ...
        <li>
          ...
          <ol className="list-alpha">
            <li>
              Falling is an ever-present danger on the trails, with potentially
              serious consequences. Parts of the trail are narrow, uneven, and
              slippery. There are several drops on or very near the trail.
              Extreme care must be always taken, especially in the dark.
            </li>
          </ol>
        </li>
        <li>
          ...
          <ol className="list-alpha">
            <li>
              ...
              legs occurs from participation in ultramarathons. The recovery can
              take several months. This seems to be a bigger problem in runners
        ...
        <li>
          ...
          <ol className="list-alpha">
            <li>
              ...
              prevent you from finishing. Runners must have a working knowledge
              of how to treat themselves for all of these problems on the trail.
            </li>
          </ol>
        </li>
        <li>
        ...
        <li>
          ...
          <ol className="list-alpha">
            <li>
              ...
              the correct trail, do not attempt to find your own way. If you are
              doubtful of your route, backtrack to where you last saw a trail
              marker and try to find other markers showing the direction of the
              trail. If you are unable to find your way, stay where you are!
              Shout or call out for help loudly and repeatedly until you are
              heard. Wandering randomly will take you farther from the trail and
              reduce your chances of being found.
            </li>
          </ol>
        </li>
        <li>
          ...
          <ol className="list-alpha">
            <li>
              ...
              vehicles. Accordingly, in spite of the safety precautions taken by
              the organisers, there is absolutely no assurance that aid or
        ...
        <li>
          ...
          <ol className="list-alpha">
            <li>
              ...
              dizzy, disoriented, or confused, do not risk falling. Sit down ON
              THE TRAIL until you recover or are found. An unconscious runner
              even a few feet off the trail could be impossible to find until it
              is too late. If you are assisted by individuals who are not
              associated with the race officials and you choose to leave the
              trail, you MUST notify the official at the nearest checkpoint of
    ...
    <div className="bg-[#fcf6e4] border border-solid border-red-300 my-4 px-8 py-3 rounded-lg">
      <b className="text-[13px]">
        Embrace the extraordinary; in our club, we shape dreams into realities,
